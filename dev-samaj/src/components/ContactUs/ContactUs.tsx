...
const ContactUs = () => {
  ...
  <div id="map" className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.0499892487046!2d77.24892887549842!3d28.56826157569986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce3b00c441967%3A0x2bcc9bb6a19a6c58!2sDev%20Samaj%20Modern%20School!5e0!3m2!1sen!2sin!4v1732886406961!5m2!1sen!2sin" width="100%" height="480" style={{'border':'0'}} loading="lazy" />
    
  </div>
  <motion.div variants={SlideUp(0.5)}
              initial="hidden"
              whileInView={"visible"} className="container px-6 md:px-12">
          ...
          <div className="flex flex-wrap">
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
              <div className="align-start flex">
                <div className="shrink-0">
                  <div className="inline-block rounded-md bg-sky-200 p-4 text-primary">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" className="w-7 h-7" viewBox="0 0 111.756 122.879" enable-background="new 0 0 111.756 122.879" xmlSpace="preserve">
                      <g>
